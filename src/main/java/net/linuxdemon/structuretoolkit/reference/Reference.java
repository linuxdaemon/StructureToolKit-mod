package net.linuxdemon.structuretoolkit.reference;

import net.linuxdemon.structuretoolkit.creativetab.CreativeTab;
import net.minecraft.creativetab.CreativeTabs;

public class Reference
{
	public static final String MOD_ID = "StructureToolKit";
	public static final String MOD_NAME = "Structure Tool Kit";
